...
public static class Patcher
{
    ...
    private static void PatchVR(string gameManagersBackupPath, string gameManagersPath, string classDataPath)
    {
        ...
        Console.WriteLine($"gameManagersBackupPath '{gameManagersBackupPath}'");
        ...
        buildSettings.ReadName(ggmFile, out string buildSettingsName);
        Console.WriteLine($"buildSettings '{buildSettingsName}'");
        Console.WriteLine($"ggmFile '{ggmFile}'");
